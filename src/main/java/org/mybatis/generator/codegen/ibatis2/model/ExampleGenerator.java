...
public class ExampleGenerator extends AbstractJavaGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        // add field, getter, setter for orderby clause
        Field fieldOffset = new Field();
        fieldOffset.setVisibility(JavaVisibility.PROTECTED);
        fieldOffset.setType(FullyQualifiedJavaType.getIntInstance());
        fieldOffset.setName("offset"); //$NON-NLS-1$
        commentGenerator.addFieldComment(fieldOffset, introspectedTable);
        topLevelClass.addField(fieldOffset);
        ...
        // add field, getter, setter for orderby clause
        Field fieldLimit = new Field();
        fieldLimit.setVisibility(JavaVisibility.PROTECTED);
        fieldLimit.setType(FullyQualifiedJavaType.getIntInstance());
        fieldLimit.setName("limit"); //$NON-NLS-1$
        commentGenerator.addFieldComment(fieldLimit, introspectedTable);
        topLevelClass.addField(fieldLimit);
